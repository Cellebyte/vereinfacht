...
COPY web_application/package.json \
     web_application/yarn.lock* \
     web_application/package-lock.json* \
     web_application/pnpm-lock.yaml* \
     ./
...
# next 13.3.0 introduced a image component bug, this is the workaround, remove when fixed
...
# This should be ipv6 compatible
ENV HOSTNAME="::"
CMD ["node", "server.js"]
